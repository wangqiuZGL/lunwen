...
"""
    Derived from the BEiT-3 model code.  
"""
...
class BEiT3(nn.Module):
    ...
    def forward(
        ...
        if textual_tokens is None:  # 已经兼容了 MIM
            ...
            # 如果文本部分有mask，则将文本mask和视觉mask（全0）进行拼接
        ...
        encoder_out = self.encoder(
            src_tokens=None,
            encoder_padding_mask=encoder_padding_mask,  # 编码的mask只是文本的 mask
            attn_mask=attn_mask,
            token_embeddings=x,
