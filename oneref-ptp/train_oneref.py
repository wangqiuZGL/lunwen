...
def get_args_parser():
    ...
    parser.add_argument('--dynamic_mask_ratio', type=float, default=0.75)  # import args
        ...
        # Syntax-Guided Attention Args
    parser.add_argument('--enable_syntax_bias', action='store_true', help="If true, enable syntax-guided attention bias", default=False)
    parser.add_argument('--syntax_bias_lambda', type=float, default=0.1, help="Lambda parameter for syntax bias strength")
    
    # PTP Auxiliary Supervision Args
    ...
    parser.add_argument('--ptp_loss_weight', type=float, default=0.1, 
                        help="Weight for PTP auxiliary loss")
